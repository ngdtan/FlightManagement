...
if __name__ == '__main__':
    with app.app_context():
        ...
        u = NguoiDung(hoTen='Tuấn Kiệt', CCCD='079203004145', SDT='0901147032', email='a@gmail.com', username='admin1',
                      password=str(hashlib.md5("123456".encode('utf-8')).hexdigest()), user_role=UserRole.ADMIN)
        db.session.add(u)
        db.session.commit()
